...
class Institutions(models.Model):
    symbol = models.TextField(blank=True, primary_key=True)
...
class Metadata(models.Model):
    sector = models.TextField(blank=True, primary_key=True)
...
class Reports(models.Model):
    sub_sector = models.TextField(blank=True, primary_key=True)
